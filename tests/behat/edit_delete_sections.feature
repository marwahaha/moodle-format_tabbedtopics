@format @format_tabtopics
Feature: Sections can be edited and deleted in tabtopics format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete tabtopics
  ...
  @javascript
  Scenario: Inline edit section name in tabtopics format
  ...
  Scenario: Deleting the last section in tabtopics format
  ...
  Scenario: Deleting the middle section in tabtopics format
